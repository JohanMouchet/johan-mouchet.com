...
import { Expertises, AcademicQualification, SocialMedia, Experience, Reference, PersonalWorks } from "../components/";
					...
					<article className="p-career-experiences">
						...
						<Experience props={{
							experiences: [
							{
								...
								endDate: "Present",
								lede:	"Global agency that delivers digital transformation powered by creativity, who believe in <em>Ideas Without Limits</em>, pushing the boundaries of technology and creativity.",
								projects: [
									{
										name: "Zoos Victoria",
										...
										awards: [
											{
												...
												URL: "https://twitter.com/isobarAU/status/1058125158752313344?s=20",
												category: "Best PR experience"
											},
											{
												name: "One Show Awards shortlist",
												URL: "https://www.oneshow.org/viewentries/?id=51888",
							...
							},
							{
									...
									endDate: "01/10/2017",
									lede:	"Leading digital marketing, technology and commerce consultancy which delivers at a UK, pan-European and global level.",
									projects: [
										{
											name: "Lexus",
											tagline: "v11",
								...
								},
								{
									...
									location: "London",
									jobTitle: "Designer &amp; Front-end developer &amp; Marketing strategist",
									startDate: "01/06/2016",
									endDate: "01/11/2016",
									contractType: "Contractor",
									lede: "Design, development and marketing strategy for a company that trains marine and offshore personnel on safety at sea.",
									projects: [
										{
											name: "Survie Mer Formation",
											URL: "https://www.surviemerformation.com/",
								...
								},
								{
									...
									endDate: "01/05/2016",
									lede:	"Award winning marketing agency which helps some of the world's most respected brands to strategically develop and implement marketing communications.",
									projects: [
										{
							...
							experiences: [
								{
									...
									endDate: "01/10/2013",
									contractType: "Intern",
									lede: "PrestaShop eCommerce website for a garden products supplier. (The owner decided to close the website)."
								},
								{
									company: {
										name: "Radigraph",
									...
									lede: 'Website development for a print company: product database, elaborated quotation, <abbr title="Search Engine Optimization">SEO</abbr>.'
								},
								{
									company: {
										name: "Winlink santé",
									...
									lede: "Web intranet application for personnel management: account management, interactive calendar, multiple databases."
								},
								{
									company: {
										name: "Digitick",
							...
							references: [
								{
									...
									contacts: {
										...
										linkedin: "https://www.linkedin.com/in/kevin-mar-molinero-3b6695a"
									}
								},
								{
									name: "Neil Brown",
									...
									contacts: {
										...
										linkedin: "https://www.linkedin.com/in/neil-brown-714a3017"
									}
								},
								{
									name: "Ciaran PARK",
