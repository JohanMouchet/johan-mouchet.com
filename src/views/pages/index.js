        ...
        <div className="grid grid--lgGutter-@xs">
          <div className="l-cell--gray-lighter cell cell--12-@xs cell--3-@md">
            ...
            <article className="p-skills">
              <h2>Skills</h2>
              <p>
                Sass, BEM, ITCSS, Bootstrap, Nunjucks / Twig / Handlebars, CMS,
                Microdata, ES2017, jQuery, APIs, Webpack, Yarn / npm, Gulp /
                Grunt, Git (Gitflow), Zeplin / InVision / Photoshop, Responsive
                design, Web performance, Cross-browser compatibility,
                Accessibility, Standards, Search Engine Marketing, Analytics,
