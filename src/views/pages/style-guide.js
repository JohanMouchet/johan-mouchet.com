          ...
          <main className="l-main cell cell--12-@xs cell--10-@md u-counter">
            ...
            <article id="sg-typography" className="l-article">
              <h2
                ...
                data-counter-separator="."
              >
                <a href="style-guide#sg-typography" className="u-anchor__link">
                  #
                </a>
                Typography
              </h2>
            ...
            <article id="sg-blockquote" className="l-article">
              <h2
                ...
                data-counter-separator="."
              >
                <a href="style-guide#sg-blockquote" className="u-anchor__link">
                  #
                </a>
                Blockquote
              </h2>
            ...
            <article id="sg-grid" className="l-article">
              ...
              <pre>
                <code>
                  &lt;div className="container <i>container--*</i>"&gt; &lt;div
                  className="grid <i>g--modifier-*</i>"&gt; &lt;div
              ...
              <form className="o-form" method="post" action="">
                ...
                <fieldset className="o-form__fieldset">
                  ...
                  <p>
                    ...
                    <a href="style-guide#sg-alert">alerts</a> for state messages
                  </p>
                  <div className="grid">
            ...
            <article id="sg-breadcrumb" className="l-article">
              <h2
                ...
                data-counter-separator="."
              >
                <a href="style-guide#sg-breadcrumb" className="u-anchor__link">
                  #
                </a>
                Breadcrumb
              </h2>
            ...
            <article id="sg-pagination" className="l-article">
              <h2
                ...
                data-counter-separator="."
              >
                <a href="style-guide#sg-pagination" className="u-anchor__link">
                  #
                </a>
                Pagination
              </h2>
            ...
            <article id="sg-footnotes" className="l-article">
              ...
              <p>
                ...
                velit illum nihil deleniti aliquam hic accusantium numquam sunt
                et, rem, ut ratione. Lorem ipsum dolor sit amet, consectetur
            ...
            <article id="sg-guidelines" className="l-article">
              <h2
                ...
                data-counter-separator="."
              >
                <a href="style-guide#sg-guidelines" className="u-anchor__link">
                  #
                </a>
                Coding guidelines
              </h2>
