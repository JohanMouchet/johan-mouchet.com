        ...
        <div className="grid">
          ...
          <main className="l-main cell cell--12-@xs cell--10-@md u-counter">
              ...
              <div className="grid">
                ...
                <div className="o-card-group cell cell--12-@xs cell--6-@sm cell--3-@md">
                  <Card
                    ...
                    className={["sg-typeface", "sg-typeface--font-quaternary"]}
                  />
                </div>
              </div>
            ...
            <article id="sg-blockquote" className="l-article">
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Maxime, cupiditate, rerum. Porro fuga laudantium tempore! Illum
                modi natus, reiciendis? Saepe quos id sunt. Iste officiis
                facilis, velit facere culpa iusto. Lorem ipsum dolor sit amet,
                consectetur adipisicing elit. Hic autem laborum, iusto quis
                sapiente! Corporis quia sit doloremque harum modi distinctio
                perspiciatis molestiae a quo soluta quidem, fugiat ad tempora.
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum
                delectus vero, cupiditate iusto voluptates commodi excepturi,
                dolores ipsa perspiciatis quo officia numquam eveniet
                praesentium, ad expedita. Rem voluptatem ipsam temporibus. Lorem
    ...
    <div className="cell c--modifier-*"></div>
              ...
              <form className="o-form" method="post" action="">
                ...
                <fieldset className="o-form__fieldset">
                  ...
                  <p>
                    ...
                    <br />
                    <br />
                    <em>Recommendation:</em> use <a href="#sg-alert">alerts</a>{" "}
                    for state messages
                  </p>
                  <div className="grid">
                  ...
                  <Card
                    ...
                    body={
                      <p>
                        ...
                        consectetur adipisicing elit. Rem omnis distinctio
                        nihil, neque sequi fugiat facilis, ducimus doloribus,
                        officia iste laudantium quas veniam. Nulla facilis amet,
                        expedita est aut aliquid.
                      </p>
                    }
                    footer={<a href="!#">Read more</a>}
                  />
            ...
            <article id="sg-footnotes" className="l-article">
              ...
              <p>
                ...
                Perferendis earum explicabo possimus odit porro odio velit illum
                nihil deleniti aliquam hic accusantium numquam sunt et, rem, ut
                ratione. Lorem ipsum dolor sit amet, consectetur adipisicing
                elit. Laborum ex voluptates, eos doloribus ipsam numquam ad
                inventore consequuntur dolorum ipsum eveniet maxime fuga,
                quaerat animi sit iste. Dignissimos, sit eligendi.
              </p>
