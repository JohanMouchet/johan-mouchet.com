...
const StyleGuide = () => (
      ...
      <div className="grid">
        <aside className="l-aside cell cell--12-@xs cell--2-@md">
          ...
          <ol className="o-list--lg o-list--hStriped o-list--linkBlock o-list--responsive-capped">
            <li>
              <a href="#styleguide-colorPalette">Color palette</a>
            </li>
            <li>
              <a href="#styleguide-typography">Typography</a>
            </li>
            <li>
              <a href="#styleguide-blockquote">Blockquote</a>
            </li>
            <li>
              <a href="#styleguide-grid">Grid</a>
            </li>
            <li>
              <a href="#styleguide-form">Form</a>
            </li>
            <li>
              <a href="#styleguide-button">Button</a>
            </li>
            <li>
              <a href="#styleguide-list">List</a>
            </li>
            <li>
              <a href="#styleguide-table">Table</a>
            </li>
            <li>
              <a href="#styleguide-card">Card</a>
            </li>
            <li>
              <a href="#styleguide-figure">Figure</a>
            </li>
            <li>
              <a href="#styleguide-breadcrumb">Breadcrumb</a>
            </li>
            <li>
              <a href="#styleguide-tabs">Tabs</a>
            </li>
            <li>
              <a href="#styleguide-details">Details</a>
            </li>
            <li>
              <a href="#styleguide-pagination">Pagination</a>
            </li>
            <li>
              <a href="#styleguide-alert">Alert</a>
            </li>
            <li>
              <a href="#styleguide-tooltip">Tooltip</a>
            </li>
            <li>
              <a href="#styleguide-progress-bar">Progress bar</a>
            </li>
            <li>
              <a href="#styleguide-badge">Badge</a>
            </li>
            <li>
              <a href="#styleguide-loader">Loader</a>
            </li>
            <li>
              <a href="#styleguide-footnotes">Footnotes</a>
            </li>
            <li>
              <a href="#styleguide-guidelines">Coding guidelines</a>
            </li>
          </ol>
        </aside>
        ...
        <main className="l-main cell cell--12-@xs cell--10-@md u-counter">
          ...
          >
            ...
            >
              <a href="#styleguide-colorPalette" className="u-anchor__link">
                #
              </a>
              Color palette
            </h2>
            <div className="grid color-palette-row">
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
                <Card
                  size="sm"
                  banner={<div className="styleguide-swatch__color"></div>}
                  body={
                    <>
                      <div className="styleguide-swatch__color-code"></div>
                      <code className="styleguide-swatch__color-name u-select--all">
                  ...
                  className={[
                    "styleguide-swatch",
                    "styleguide-swatch--primary-lighter",
                  ]}
                />
              </div>
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
              ...
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
                <Card
                  ...
                  className={[
                    "styleguide-swatch",
                    "styleguide-swatch--primary-darker",
                  ]}
                />
              </div>
              ...
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
                <Card
                  ...
                  className={[
                    "styleguide-swatch",
                    "styleguide-swatch--secondary-lighter",
                  ]}
                />
              </div>
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
              ...
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
                <Card
                  ...
                  className={[
                    "styleguide-swatch",
                    "styleguide-swatch--secondary-darker",
                  ]}
                />
              </div>
              ...
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
                <Card
                  ...
                  className={[
                    "styleguide-swatch",
                    "styleguide-swatch--gray-lighter",
                  ]}
                />
              </div>
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
                <Card
                  ...
                  className={["styleguide-swatch", "styleguide-swatch--gray"]}
                />
              </div>
              <div className="o-card-group cell cell--12-@xs cell--4-@sm">
                <Card
          ...
          <article id="styleguide-typography" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-typography" className="u-anchor__link">
                #
              </a>
              Typography
            </h2>
            <div className="grid">
              <div className="o-card-group cell cell--12-@xs cell--6-@sm cell--3-@md">
                <Card
                  size="sm"
                  header={
                    <span className="styleguide-typeface__glyph">Aa</span>
                  }
                  body={
                    <>
                      <h3>Primary typeface</h3>
                      <p className="styleguide-typeface__name"></p>
                    </>
                  }
                  className={[
                    "styleguide-typeface",
                    "styleguide-typeface--font-primary",
                  ]}
                />
              </div>
              <div className="o-card-group cell cell--12-@xs cell--6-@sm cell--3-@md">
                <Card
                  ...
                  className={[
                    "styleguide-typeface",
                    "styleguide-typeface--font-secondary",
                  ]}
                />
              </div>
              <div className="o-card-group cell cell--12-@xs cell--6-@sm cell--3-@md">
                <Card
                  ...
                  className={[
                    "styleguide-typeface",
                    "styleguide-typeface--font-tertiary",
                  ]}
                />
              </div>
              <div className="o-card-group cell cell--12-@xs cell--6-@sm cell--3-@md">
                <Card
                  ...
                  className={[
                    "styleguide-typeface",
                    "styleguide-typeface--font-quaternary",
                  ]}
                />
              </div>
            </div>
            <div className="grid grid--lgGutter-@xs">
              ...
              <div className="cell cell--12-@xs cell--7-@md">
                ...
                <p>
                  ...
                  Fuga, distinctio? Aliquam, voluptas. Aspernatur quaerat
                  consequatur laudantium facilis placeat beatae autem.
                </p>
          ...
          <article id="styleguide-blockquote" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-blockquote" className="u-anchor__link">
                #
              </a>
              Blockquote
            </h2>
            ...
            <p>
              ...
              cupiditate, rerum. Porro fuga laudantium tempore! Illum modi
              natus, reiciendis? Saepe quos id sunt. Iste officiis facilis,
              velit facere culpa iusto. Lorem ipsum dolor sit amet, consectetur
              adipisicing elit. Hic autem laborum, iusto quis sapiente! Corporis
              quia sit doloremque harum modi distinctio perspiciatis molestiae a
              quo soluta quidem, fugiat ad tempora. Lorem ipsum dolor sit amet,
              consectetur adipisicing elit. Harum delectus vero, cupiditate
              iusto voluptates commodi excepturi, dolores ipsa perspiciatis quo
              officia numquam eveniet praesentium, ad expedita. Rem voluptatem
              ipsam temporibus. Lorem ipsum dolor sit amet, consectetur
              adipisicing elit.
            </p>
          </article>
          ...
          <article id="styleguide-grid" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-grid" className="u-anchor__link">
                #
              </a>
              Grid
            </h2>
  ...
  <div className="grid g--modifier-*">
    <div className="cell c--modifier-*"></div>
          ...
          <article id="styleguide-form" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-form" className="u-anchor__link">
                #
              </a>
              Form
            </h2>
            ...
            <p>
              ...
              <code>[type="email"]</code>, <code>[type="tel"]</code> etc.) for
            ...
            <form className="o-form" method="post" action="">
                ...
                <div className="grid">
                  ...
                  <div className="cell cell--12-@xs cell--6-@md">
                    ...
                    <div className="o-form__group">
                      ...
                      <Radio type="radio" name="radioChoice" value="option-2">
                        Option 2
                      </Radio>
              ...
              <fieldset className="o-form__fieldset">
                ...
                <p>
                  ...
                  <a href="#styleguide-alert">alerts</a> for state messages
                </p>
                <div className="grid">
          ...
          <article id="styleguide-button" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-button" className="u-anchor__link">
                #
              </a>
              Button
            </h2>
            ...
            <p>
              ...
              using <a href="https://simpleicons.org/">Simple Icons</a> set (see
              on <a href="https://github.com/danleech/simple-icons">GitHub</a>
              ). Replace{" "}
              <code>
                <i>{`{URL}`}</i>
              </code>
          ...
          <article id="styleguide-list" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-list" className="u-anchor__link">
                #
              </a>
              List
            </h2>
          ...
          <article id="styleguide-table" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-table" className="u-anchor__link">
                #
              </a>
              Table
            </h2>
            ...
            <p>
              <em>Suggestion:</em> use <code>.u-counter</code> to number table
              rows
            </p>
            <div className="grid grid--lgGutter-@xs">
              <div className="cell cell--12-@xs cell--6-@md">
              ...
              <div className="cell cell--12-@xs cell--6-@md">
                ...
                <p>
                  ...
                  <br />
                  (Not compatible with <code>.o-table--striped</code> and{" "}
                  <code>.o-table--hover</code>)
                </p>
                <table className="o-table o-table--responsive o-table--responsive-shadow">
                  <thead>
                    <tr>
          ...
          <article id="styleguide-card" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-card" className="u-anchor__link">
                #
              </a>
              Card
            </h2>
            ...
            <p>
              ...
              <code>&amp;.o-card--lg</code>, <code>&amp;.o-card--hover</code>,{" "}
                  ...
                  body={
                    <>
                      <p>
                        ...
                        elit. Ipsa, exercitationem dicta temporibus perspiciatis
                        nesciunt accusamus cum, itaque at necessitatibus nostrum
                        aut quo assumenda, culpa amet id. Suscipit provident,
                        dolorem recusandae. Lorem ipsum dolor sit amet,
                        consectetur adipisicing elit.
                      </p>
                      <p>
                        Rem omnis distinctio nihil, neque sequi fugiat facilis,
                        ducimus doloribus, officia iste laudantium quas veniam.
                        Nulla facilis amet, expedita est aut aliquid.
                      </p>
                    </>
                  }
                  footer={
              ...
              <div className="o-card-group cell cell--12-@xs cell--6-@sm cell--4-@md">
                <Card
                  ...
                  body={
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Ipsa, exercitationem dicta temporibus perspiciatis
                      nesciunt accusamus cum, itaque at necessitatibus nostrum
                      aut quo assumenda, culpa amet id. Suscipit provident,
                      dolorem recusandae.
                    </p>
                ...
                <Card
                  ...
                  body={
                    <p>
                      ...
                      aut quo assumenda, culpa amet id. Suscipit provident,
                      dolorem recusandae. Lorem ipsum dolor sit amet,
                      consectetur adipisicing elit. Rem omnis distinctio nihil,
                      neque sequi fugiat facilis, ducimus doloribus, officia
                      iste laudantium quas veniam. Nulla facilis amet, expedita
                      est aut aliquid.
                    </p>
                  }
                  footer={<a href="!#">Read more</a>}
          ...
          <article id="styleguide-figure" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-figure" className="u-anchor__link">
                #
              </a>
              Figure
            </h2>
            ...
            <Figure
              ...
              caption={
                <>
                  Fig1. See on{" "}
                  <a href="https://unsplash.com/photos/sTBdWFQKDHE">Unsplash</a>
                </>
              }
            />
          ...
          <article id="styleguide-breadcrumb" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-breadcrumb" className="u-anchor__link">
                #
              </a>
              Breadcrumb
            </h2>
          ...
          <article id="styleguide-tabs" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-tabs" className="u-anchor__link">
                #
              </a>
              Tabs (JS)
            </h2>
          ...
          <article id="styleguide-details" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-details" className="u-anchor__link">
                #
              </a>
              Details
            </h2>
            <Details summary="Lorem ipsum" attributes={{ open: true }}>
              ...
              voluptate sequi, exercitationem, corrupti recusandae
            ...
            <Details summary="Dolor sit amet">
              ...
              consequatur maxime nulla corrupti tempora eaque neque fuga iure
              libero, mollitia corporis sunt eligendi, quod facere at. Inventore
              dolore, vitae aliquam.
            </Details>
            <Details summary="Consectetur adipisicing elit">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea,
              temporibus, fugiat. Harum deserunt blanditiis iusto ea odio et id,
              quos, laudantium veniam mollitia animi obcaecati quas rerum,
          ...
          <article id="styleguide-pagination" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-pagination" className="u-anchor__link">
                #
              </a>
              Pagination
            </h2>
          ...
          <article id="styleguide-alert" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-alert" className="u-anchor__link">
                #
              </a>
              Alert (JS)
            </h2>
            <p>
              <code>.o-alert</code>. To show with <code>&amp;.is--visible</code>
            </p>
          ...
          <article id="styleguide-tooltip" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-tooltip" className="u-anchor__link">
                #
              </a>
              Tooltip
            </h2>
          ...
          <article id="styleguide-progress-bar" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-progress-bar" className="u-anchor__link">
                #
              </a>
              Progress bar
            </h2>
          ...
          <article id="styleguide-badge" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-badge" className="u-anchor__link">
                #
              </a>
              Badge
            </h2>
          ...
          <article id="styleguide-loader" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-loader" className="u-anchor__link">
                #
              </a>
              Loader
            </h2>
          ...
          <article id="styleguide-footnotes" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-footnotes" className="u-anchor__link">
                #
              </a>
              Footnotes
            </h2>
            <p>
              Lorem ipsum
              <FootnotesReference id="1" text="[1]" url="" /> dolor sit amet,
              consectetur adipisicing elit. Dignissimos
              <FootnotesReference id="2" text="[2]" url="" />, qui? Perferendis
              earum explicabo possimus odit porro odio velit illum nihil
              deleniti aliquam hic accusantium numquam sunt et, rem, ut ratione.
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum
              ex voluptates, eos doloribus ipsam numquam ad inventore
              consequuntur dolorum ipsum eveniet maxime fuga, quaerat animi sit
              iste. Dignissimos, sit eligendi.
            </p>
          ...
          <article id="styleguide-guidelines" className="l-article">
            <h2
              className="u-counter__index-1 u-counter__index--space u-anchor"
              data-counter-separator="."
            >
              <a href="#styleguide-guidelines" className="u-anchor__link">
                #
              </a>
              Coding guidelines
            </h2>
            <p>
              ...
              developers, it is important to work in a unified way in order to
            ...
            <div className="grid grid--lgGutter-@xs">
              <div className="cell cell--12-@xs cell--4-@md">
                ...
                <ul>
                  ...
                  <li>
                    <code>Partials</code>: page unique item grouping components
                  </li>
                  <li>
              ...
              <div className="cell cell--12-@xs cell--4-@md">
                <h4>Templates</h4>
                <p>
                  <a href="https://twig.symfony.com/">Twig</a>, using the MVC
                  methodology.
                </p>
                <ul>
                  <li>
            ...
            <p>
              An <em>editorconfig</em> is used to enforce basic code constancy.
            ...
            <p>
              <em>Linters</em> are used for advanced configuration. It is highly
              recommended to use in-IDE linters for instant feedback. Here are
              few notable rules:
            </p>
            <div className="grid grid--lgGutter-@xs">
              <div className="cell cell--12-@xs cell--4-@md">
              ...
              <div className="cell cell--12-@xs cell--4-@md">
                ...
                <ul>
                  ...
                  <li>
                    <a href="http://eslint.org/docs/rules/max-len">max-len</a>:
                    0
                  </li>
                  <li>
                    <a href="http://eslint.org/docs/rules/no-var">no-var</a>: 0
                  </li>
                </ul>
                <small>
                  Read the <a href="http://eslint.org/docs/rules/">doc</a> for
                  explanations on each rule.
                </small>
              </div>
            </div>
          </article>
